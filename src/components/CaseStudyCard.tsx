  ...
  return (
    ...
    >
      ...
      <div className="absolute bottom-0 left-0 p-6 w-full flex flex-col justify-between h-full">
        <div>
          <div className="min-h-[1.5rem] text-sm text-primary-400 mb-5">
            {categoryDisplay}
        </div>
        ...
        <p className="min-h-[3.5rem] text-gray-400 text-sm leading-relaxed max-w-md opacity-0 group-hover:opacity-100 transition-opacity duration-300">
          {description}
        </p>
      </div>
